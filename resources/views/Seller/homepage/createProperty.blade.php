		...
		<div class="box-body">
			...
			<form action="{{ route('property.store') }}" method="post" class="form-horizontal">
				...
				<div class="form-group{{ $errors->has('photo1') ? ' has-error' : '' }}">
					...
					<div class="col-md-6">
						<input type="file" class="form-control pull-right" id="photo1" name="photo1" placeholder="Prefered Experience" min="0" value="{{ $property->photo1 }}">
					</div>
				</div>
				...
				<div class="form-group{{ $errors->has('photo2') ? ' has-error' : '' }}">
					...
					<div class="col-md-6">
						<input type="file" class="form-control pull-right" id="photo2" name="photo2" placeholder="Prefered Experience" min="0" value="{{ $property->photo2 }}">
					</div>
				</div>
				...
				<div class="form-group{{ $errors->has('photo3') ? ' has-error' : '' }}">
					...
					<div class="col-md-6">
						<input type="file" class="form-control pull-right" id="photo3" name="photo3" placeholder="Prefered Experience" min="0" value="{{ $property->photo3 }}">
					</div>
				</div>	
